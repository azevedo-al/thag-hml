...
{
    public abstract class SistemaDeGestaoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SistemaDeGestaoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SistemaDeGestaoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SistemaDeGestaoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SistemaDeGestaoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SistemaDeGestaoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SistemaDeGestaoDbContext, Task<T>> func)
        {
            T result;
