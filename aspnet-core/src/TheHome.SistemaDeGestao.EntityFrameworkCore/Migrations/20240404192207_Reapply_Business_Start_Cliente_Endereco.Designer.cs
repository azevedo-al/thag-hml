...
namespace TheHome.SistemaDeGestao.Migrations
{
    ...
    [Migration("20240404192207_Reapply_Business_Start_Cliente_Endereco")]
    partial class Reapply_Business_Start_Cliente_Endereco
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheHome.SistemaDeGestao.Business.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheHome.SistemaDeGestao.Business.Endereco", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("TheHome.SistemaDeGestao.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("TheHome.SistemaDeGestao.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("TheHome.SistemaDeGestao.Business.Cliente", b =>
                {
                    b.HasOne("TheHome.SistemaDeGestao.Business.Endereco", "EnderecoResidencia")
                        .WithMany()
