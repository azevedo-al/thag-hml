...
namespace TheHome.SistemaDeGestao.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = SistemaDeGestaoConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(SistemaDeGestaoDbContext context)
        {
            _context = context;
        }
